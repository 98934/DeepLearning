"""ResNeXt models for TensorFlow2.

# Reference

- [Aggregated Residual Transformations for Deep Neural Networks](https://arixiv.org/pdf/1611.05431.pdf)
- [TensorFlow2 implement ResNeXt](https://github.com/calmisential/ResNeXt_TensorFlow2)
    ...
    def __init__(self,
        ...
        for i in range(self.groups):
            self.conv_list.append(tf.keras.layers.Conv2D(filters=self.group_out_num,
                                                         ...
                                                         activity_regularizer=activations.get(activity_regularizer),
